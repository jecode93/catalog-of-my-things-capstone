...
class App
  ...
  def actions(option)
    methods = [method(:create_book), 'Music added', method(:create_game), method(:list_books), 'All music albums', method(:list_games),
               'All genres', method(:list_labels), method(:list_authors)]
